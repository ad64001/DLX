		...
		<view style="padding: 20rpx;">
			<view>
				<uni-group style="padding: 10rpx;" margin-top="20" mode="card" v-for="(item,index) in list">
					<view>
						<view style="position: absolute;right: 100rpx;"><u-icon name="setting" @click="tos(item.id)" color="#0088f0" size="40"></u-icon></view>
			...
			<view><button @click="tos(0)" style="background: linear-gradient(180deg,#00dee5,#00eee5); color: #fff;">添加</button></view>
		</view>
			...
			<uni-grid :column="4" :showBorder="false" :highlight="false">
				...
				<uni-grid-item>
					<view style="margin: auto;" @click="to(1)">
						<view style="display: flex; margin: auto;">
							<image style=" width: 50rpx; height: 50rpx; margin: auto;" src="../../../../static/icons/news.png" mode=""></image>
						</view>
				...
				<uni-grid-item>
					<view style="margin: auto;" @click="to(3)">
						<view style="display: flex; margin: auto;" >
							<image style=" width: 50rpx; height: 50rpx; margin: auto;" src="../../../../static/icons/all_act.png" mode=""></image>
						</view>
	...
	export default {
		...
		methods: {
			to(e){
				if(e == 1){
					uni.redirectTo({
						url: '/pages/service/yuyuCar/yuyuCar',
						success: res => {},
						fail: () => {},
						complete: () => {}
					});
			...
			tos(e){
				if(e==0){
					uni.navigateTo({
						url: '/pages/service/yuyuCar/moreCL/moreTJC',
						success: res => {},
						fail: () => {},
						complete: () => {}
					});
					...
					uni.navigateTo({
						url: '/pages/service/yuyuCar/moreCL/moreXGC?id='+e,
						success: res => {},
						fail: () => {},
						complete: () => {}
					});
